<!-- Popup Overlay -->
<div id="popupOverlay"
    class="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50 opacity-0 invisible transition-all duration-300">

    <!-- Popup Box -->
    <div
        class="w-full max-w-md bg-white shadow-2xl overflow-hidden relative bg-cover" style="background-image: url('{{ asset('gallery/popup-bg.webp') }}')">

        <!-- Close Button -->
        <button id="closePopup"
            class="absolute top-2 right-2 text-white w-7 h-7 rounded flex items-center justify-center text-sm font-bold hover:bg-red-700 transition z-10">
            ✕
        </button>

        <!-- Header -->
        <div class="bg-[#6B3A00] text-center py-8" style="clip-path: polygon(100% 0px, 100% 70%, 50% 100%, 0px 70%, 0px 0px);">
